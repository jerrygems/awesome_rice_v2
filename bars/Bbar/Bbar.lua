...
vicious.register(info1, vicious.widgets.wifi, function(widget, args)
    info1.markup = "<span font='KodeMono 12'> 󰹤 " .. args["{sign}"] .. "</span>"
end, 2, "wlan0")

local info5 = wibox.widget.textbox()
info5.forced_width = 120
vicious.register(info5, vicious.widgets.uptime, "<span font='KodeMono 12'><b> 󱟠 </b>$3 min</span>", 60)


local info4 = wibox.widget.textbox()
info4.forced_width = 450
vicious.register(info4, vicious.widgets.os, "<span font='KodeMono 12'>  $3@$4<b>  </b>" .. output0 .. "  </span>", 2)
...
info2.align = 'center'
vicious.register(info2, vicious.widgets.mem, "<span font='KodeMono 12'> <b></b> $2MB</span>", 13)

local info3 = wibox.widget.textbox()
info3.forced_width = 120
vicious.register(info3, vicious.widgets.cpufreq, "<span font='KodeMono 12'> <b></b> $1 </span>", 2, "cpu0")
