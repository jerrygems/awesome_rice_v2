...
local imga = gears.color.recolor_image(home_dir .. "/.config/awesome/icons/discord.svg", config.icons_df_clr_on_hover)
local imgb = gears.color.recolor_image(home_dir .. "/.config/awesome/icons/flameshot.svg", config.icons_df_clr_on_hover)
local imgc = gears.color.recolor_image(home_dir .. "/.config/awesome/icons/obsidian.svg", config.icons_df_clr_on_hover)
local imgd = gears.color.recolor_image(home_dir .. "/.config/awesome/icons/vbox.png", config.icons_df_clr_on_hover)
local imge = gears.color.recolor_image(home_dir .. "/.config/awesome/icons/spotify.png", config.icons_df_clr_on_hover)
local imgf = gears.color.recolor_image(home_dir .. "/.config/awesome/icons/reddit.png", config.icons_df_clr_on_hover)
...
local function toolBoxBar(s)
    ...
    tool1:connect_signal("mouse::leave", function()
        tool1.image = gears.color.recolor_image(home_dir .. "/.config/awesome/icons/discord.svg",
    ...
    tool2:connect_signal("mouse::leave", function()
        tool2.image = gears.color.recolor_image(home_dir .. "/.config/awesome/icons/flameshot.svg",
            config.icons_df_clr_on_hover)
    end)
    ...
    tool3:connect_signal("mouse::leave", function()
        tool3.image = gears.color.recolor_image(home_dir .. "/.config/awesome/icons/obsidian.svg",
            config.icons_df_clr_on_hover)
    end)
    ...
    tool4:connect_signal("mouse::leave", function()
        tool4.image = gears.color.recolor_image(home_dir .. "/.config/awesome/icons/vbox.png",
            config.icons_df_clr_on_hover)
    end)
