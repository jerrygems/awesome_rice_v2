...
local imga = gears.color.recolor_image(home_dir .. "/.config/awesome/icons/notebook.svg", "#ff035bff")
local imgb = gears.color.recolor_image(home_dir .. "/.config/awesome/icons/github.png", "#ff035bff")
...
local function favourites(s)
    ...
    tool1:connect_signal("mouse::leave", function()
        tool1.image = gears.color.recolor_image(home_dir .. "/.config/awesome/icons/notebook.svg", "#ff035bff")
    end)
    tool1:buttons(
        gears.table.join(
    ...
    tool2:connect_signal("mouse::leave", function()
        tool2.image = gears.color.recolor_image(home_dir .. "/.config/awesome/icons/github.png", "#ff035bff")
    end)
    tool2:buttons(
        gears.table.join(
            awful.button({}, 1, function()
    ...
    tool3:connect_signal("mouse::leave", function()
        tool3.image = gears.color.recolor_image(home_dir .. "/.config/awesome/icons/kaggle.svg", "#ff035bff")
    end)
    tool3:buttons(
        gears.table.join(
            awful.button({}, 1, function()
    ...
    tool4:connect_signal("mouse::leave", function()
        tool4.image = gears.color.recolor_image(home_dir .. "/.config/awesome/icons/gmail.svg", "#ff035bff")
    end)
    tool4:buttons(
        gears.table.join(
            awful.button({}, 1, function()
    ...
    tool5:connect_signal("mouse::leave", function()
        tool5.image = gears.color.recolor_image(home_dir .. "/.config/awesome/icons/colab.svg", "#ff035bff")
    end)
    tool5:buttons(
        gears.table.join(
            awful.button({}, 1, function()
